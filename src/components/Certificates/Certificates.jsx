      ...
      <div className='container certificates__container'>
        <div className='certificates__frontend'>
          ...
          <div className="certificates__content">
            ...
            <article className='certificates__details'>
              <img src={Code_Academy} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
              <img src={x_lane} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={future_skill} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={monGo_DB} className='certificates__details-icon' />
              <div>
        ...
        <div className="certificates__backend">
          ...
          <div className="certificates__content">
            ...
            <article className='certificates__details'>
            <img src={cswip} className='certificates__details-icon' />
            ...
            <article className='certificates__details'>
            <img src={council} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={world_steel} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={CNI} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={thai_german} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={mtec} className='certificates__details-icon' />
              <div>
            ...
            <article className='certificates__details'>
            <img src={seda} className='certificates__details-icon' />
              <div>
